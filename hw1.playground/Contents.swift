...
//: ## Q2: Variable Types and Function Types
    class func arePalindromes(_ words: [String]) -> Bool { //func arePalindromes takes in string array labeled words and returns a boolean
        // This is a static function because at the bottom, this function is called on an array of its own so it doesn't need an instance to be called upon it. Further, it is its own class to make it static. Salil explained to me.
...
//: [This function didn't have a return true statatement because at the bottom, there are palindromes that get passed into this function.]
    
    
//: ## Q3: More Functions and Object Initialization
    func isAnagram() -> Bool {
        // For this function, the code at the bottom is used on an instance of the class Words object, wordsObj. This function is not static because it is used on an instance of the class Words so you need to make an instance of the class you want call this method on before you can use it to check anagrmas.
        //var countLetters : [Character : Int] //Line X
        var countLetters = [Character : Int]() //Line X, creates empty dictionary of keys character and value integer
        var lenA = self.wordA.characters.count //gets lengths of wordA and wordB
...
//: [In Line X, the convention for creating the empty dictionary would be to use an equal sign for assignment and using paranthesis after the braket to create the empty dictionary. At the bottom, isAnagram() is called on an instance of Words, wordObj. For this to work, it can't have "class" in front of the function because the code at the bottom uses this method on an instance of Words. I go into further detail in my comments at line 29 and 51]
